...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/U8rI5tBqS/model.json',modelLoaded);
...
function speak(){
    ...
    speak_data=new SpeechSynthesisUtterance(speak_data_1+speak_data_2);
